...
@click.option("--B_gen", "B_gen", type=int, default=3, help="Number of transformer blocks to encode the input sequence", required=False)
@click.option("--O_gen", "O_gen", type=int, default=3, help="Number of transformer blocks to get the output sequence", required=False)
...
@click.option("--B_disc", "B_disc", type=int, default=5, help="Number of discriminator blocks in the discriminator", required=False)
@click.option("--O_disc", "O_disc", type=int, default=5, help="Number of output transformer blocks in the discrimiantor", required=False)
