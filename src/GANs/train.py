...
@click.option("--B_disc", "B_disc", type=int, default=3, help="Number of discriminator blocks in the discriminator", required=False)
@click.option("--O_disc", "O_disc", type=int, default=1, help="Number of output MHA blocks for each transformer in the discrimiantor", required=False)
