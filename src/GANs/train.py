...
@click.option("--costSlope", "costSlope", type=float, default=0.05, help="The slope of the GLS-GAN cost function", required=False)
...
def train(
    ...
    ### Training The Model ###
    #model.loadModels("models", "gen_model - 4600.pkl", "disc_model - 100.pkl")
