...
def main():
    indir = "data/Text/train_data" # Directory with txt files to read in
    outFile = "data/Text/data.txt" # File to put all output data to
    maxSentSize = 64     # Max number of words in a sentence to load in
    limit = 10000000 # Limit on the number of sentences to load in (-1 for all)
    ...
    # The max sentence size should be 2 less than the desired size to
